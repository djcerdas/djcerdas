...
**Senior Linux Escalation Engineer at Microsoft Azure, expanding my engineering scope into software development and AI, with a growing specialization in Secure Linux Systems Development and Linux-based AI workloads powered by open-weight models.**

## About

Senior Linux Escalation Engineer at Microsoft Azure with 15+ years of experience supporting Linux workloads in enterprise cloud environments, and a Bachelor's degree in Telematics Engineering.
...
- **[AI Assistant](https://github.com/djcerdas/ai_assistant)** — Linux-based Edge AI project combining Python, computer vision, local processing, and embedded hardware.
...
- **[Azure Infrastructure Automation](https://github.com/djcerdas/ARM)** — Infrastructure-as-code work using Azure Resource Manager templates.

- **[Stylens Image Consultant](https://github.com/djcerdas/stylens-image-consultant)** — Exploration of multimodal AI, open-weight models, privacy, and local/edge AI deployment.
